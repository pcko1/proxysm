...
> [!IMPORTANT]
> Change the default passwords in `.env` before exposing Proxysm to any network. This includes `PM_ADMIN_PASSWORD`, `PM_SECRET_KEY`, and `DB_PASSWORD`.
